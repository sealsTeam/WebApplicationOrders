        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressRecipient = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderProduct", x => new { x.ItemOrderedId, x.OrdersId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_OrderProduct_Product_ItemOrderedId",
